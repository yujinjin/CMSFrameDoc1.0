...
$.extend( FixedHeader.prototype, {
	...
	_positions: function ()
	{
	    ...
	    //update by yujinjin 解决部分插件引入生成2个table,导致thead, tfoot计算不正确
		var thead = $(this.s.dt.tables().header());
		var tfoot = this.s.dt.tables().footer()[0] ? (this.s.dt.tables().footer()) : null;
		var tbody = dom.tbody;
